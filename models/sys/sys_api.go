...
type SysApi struct {
	...
	Enabled     bool   `gorm:"type:tinyint(1);default:1;index;comment:启用状态(1启用 0禁用)" json:"enabled;default=true"`
	NeedAuth    bool   `gorm:"type:tinyint(1);default:1;comment:是否需要认证(1是 0否)" json:"need_auth;default=true"`
	NeedLog     bool   `gorm:"type:tinyint(1);default:1;comment:是否需要记录日志" json:"need_log;default=true"`
	BaseModel
