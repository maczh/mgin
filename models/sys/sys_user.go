...
type SysUser struct {
	...
	UserType  string     `gorm:"type:varchar(10);comment:用户类型（根据业务自由定义）;" json:"userType" form:"userType"`
	...
	Status    uint8      `gorm:"type:tinyint;comment:帐号状态（0正常 1停用）;" json:"status" form:"status"`
