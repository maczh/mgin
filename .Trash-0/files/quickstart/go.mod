module github.com/maczh/mgin/examples/quickstart

go 1.25.7

require (
	github.com/gin-gonic/gin v1.11.0
	github.com/maczh/mgin v1.25.7
)
...
require (
	...
	github.com/maczh/mgo v1.0.4 // indirect
...
// 执行 `go mod tidy` 拉取依赖并修正版本(需联网)
replace github.com/maczh/mgin => ../..
